...
internal class Transakcja
{
    ...
    public void wypiszNaKonsole()
    {
        ...
        Console.WriteLine();
        Console.WriteLine();
        /*Co zrobić żeby metoda wyswietlZTransakcjami() z klasy Konto wykrywała rzeczywisty typ transakcji (np. przelew)?
        rzutowanie na obiekt przelew + instance of(is):
         */
        if (this is Przelew) {            
            Console.WriteLine("Nr konta:"+ ((Przelew)this).getNrKonta());
        }
    }
